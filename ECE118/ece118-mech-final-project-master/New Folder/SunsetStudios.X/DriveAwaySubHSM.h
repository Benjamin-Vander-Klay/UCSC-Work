...
#ifndef DRIVE_AWAY_SUB_HSM_H  // <- This should be changed to your own guard on both
#define DRIVE_AWAY_SUB_HSM_H  //    of these lines
...
uint8_t InitDriveAwaySubHSM(void);
...
ES_Event RunDriveAwaySubHSM(ES_Event ThisEvent);

#endif /* DRIVE_AWAY_SUB_HSM_H */
