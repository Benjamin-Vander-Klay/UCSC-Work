...
#ifndef SUB_TOWERSCOPE_HSM_H  // <- This should be changed to your own guard on both
#define SUB_TOWERSCOPE_HSM_H  //    of these lines
 ...
 * PUBLIC #DEFINES                                                             *
 ******************************************************************************/
//uint8_t tower_scope_FSM_active = FALSE;
