...
#define DRIVE_ULTRA 1000 // the forbidden drive speed. Use with Caution * Jokes aside 
#define DRIVE_MAX 900
#define DRIVE_HIGH 750
#define DRIVE_MED 500
#define DRIVE_LOW 250 // may need to raise this to ~300

// Define Ports for Motor
// right motor
#define EN_A PWM_PORTZ06
// left motor
...
#define HALL_IN_RIGHT PORTX05_BIT
#define HALL_IN_LEFT PORTX06_BIT

#define HALL_IN_PORT PORTX
#define HALL_IN_PIN_R PIN5
#define HALL_IN_PIN_L PIN6
