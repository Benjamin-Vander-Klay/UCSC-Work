...
typedef enum {
    ...
    FL_PRESSED, //FRONT LEFT BUMPER IS PRESSED
    FL_UNPRESSED, //FRONT LEFT BUMPER IS UNPRESSED
    FR_PRESSED, //FRONT RIGHT BUMPER IS PRESSED
    FR_UNPRESSED, //FRONT RIGHT BUMPER IS UNPRESSED 
    RL_PRESSED, //REAR LEFT BUMPER IS PRESSED
    RL_UNPRESSED, //REAR LEFT BUMPER IS UNPRESSED
    RR_PRESSED, //REAR RIGHT BUMPER IS PRESSED 
    RR_UNPRESSED, //REAR RIGHT BUMPER IS UNPRESSED 
    DF_DETECTED, //BOTTOM TAPE SENSOR DETECTS TAPE
    LF_DETECTED, //BOTTOM TAPE SENSOR DETECTS WHITE FLOOR
    DW_DETECTED, //SIDE TAPE SENSOR DETECTS DARK TAPE ON THE WALL
    LW_DETECTED, //SIDE TAPE SENSOR DETECTS LIGHT WALL
    BEACON_WITHIN_ANALOG_RANGE, //ANALOG BEACON DETECTS BEACON WITHIN SPECIFIC RANGR
    DF_NONE_DETECTED,
    LF_NONE_DETECTED,
    BEACON_NOT_WITHIN_ANALOG_RANGE, //ANALOG BEACON NO LONGER DETECTS BEACON 
    BEACON_WITHIN_DIGITAL_RANGE, // BEACON IS DETECTED
    BEACON_NOT_WITHIN_DIGITAL_RANGE, // BEACON IS NO LONGER DETECTED
    TW_DETECTED,//TRACK WIRE IS DETECTED 
<<<<<<< HEAD
    TW_NOT_DETECTED,//TRACK WIRE IS NO LONGER DETECTED          
    // encoder Events :
    ENCODER_TICK, // RISING EDGE FOUND ON ENCODER PIN
    ENCODER_DONE, // ENCODER COMPLETED DESIRED 
    ENCODER_SET_TICKS,// NOT USING?
            DRIVING,
            DRIVE_FORWARD_FULL,
            DRIVE_FORWARD_HALF,
            DRIVE_REVERSE_FULL,
...
=======
>>>>>>> 444183f7fa6e15da91fdf25a51b7232c6ddf2bdd
...
#define EVENT_CHECK_HEADER "EncoderEventchecker.h"

/****************************************************************************/
// This is the list of event checking functions
<<<<<<< HEAD
#define EVENT_CHECK_LIST TemplateCheckBattery,  CheckFLBumper, CheckFRBumper, CheckRLBumper, CheckRRBumper,// CheckTowerTape,CheckforBeaconDigital, CheckforBeaconAnalog,
=======
<<<<<<< HEAD
#define EVENT_CHECK_LIST CheckEncoderPWM
=======
#define EVENT_CHECK_LIST TemplateCheckBattery,CheckforBeaconDigital, //CheckBottomTapeforDark, CheckFLBumper, CheckFRBumper, CheckRLBumper, CheckRRBumper, CheckTowerTape,CheckforBeaconDigital, CheckforBeaconAnalog,
>>>>>>> 444183f7fa6e15da91fdf25a51b7232c6ddf2bdd
>>>>>>> d429440fe5571abb86d586b13aa2bb4a0a52513a
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "EncoderService.h"
// the name of the Init function
#define SERV_1_INIT InitEncoderService
// the name of the run function
#define SERV_1_RUN RunEncoderService
...
// the name of the Init function
#define SERV_2_INIT EncoderServiceInit
// the name of the run function
#define SERV_2_RUN EncoderServiceRun
// How big should this services Queue be?
