...
#ifndef BUMPERS_GEN_SUB_TEMPLATE_HSM_H  // <- This should be changed to your own guard on both
#define BUMPERS_GEN_SUB_TEMPLATE_HSM_H  //    of these lines
...
#endif /* BUMPERS_GEN_SUB_HSM_Template_H */
